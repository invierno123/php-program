...
<body>
  ...
  <table class="tab_list" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_FQWZ");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_DQZT");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_LIST_SHOW_TIME");?></td>
      ...
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_YYYL");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_GDKJ");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_LJLX");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_LCLX");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_ALERT_TJ_WENDU");?></td>
    </tr>
    <?php echo ($tab_list); ?>
  </table>
  ...
  <script>
    ...
    function page(op){
      ...
      if(pc<=apc && pc>0){
        location="checkinfo?sid="+getUrlParam("sid")+"&tid="+getUrlParam("tid")+"&p="+pc;
      }
    }
    $(function(){
      var pc='<?php echo ($pc); ?>';
