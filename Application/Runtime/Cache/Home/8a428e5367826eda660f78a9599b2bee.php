...
//  window.open("/home/warning/innit?id="+id);
    ...
    function btn_search_click(){
      ...
      $.get("Supervisory/search?area="+area+"&ts="+time_s+"&te="+time_e+"&tn="+trapno+"&tstate="+trapstate+"",function(res){
        $("#tab_show_list").html(' <tr><td style="text-align: center;color:#222;"><?php echo L("L_AREA_QY");?></td><td style="text-align: center;color:#222;"><?php echo L("L_ALERT_TJ_num");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_inpressure");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_LINkT");?></td><td style="text-align:center;color:#222;"><?php echo L("L_AREA_LINkS");?></td><td style="text-align: center;color:#222;"><?php echo L("L_ALERT_TJ_location");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_FMLX");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_PINPAI");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_outtype");?></td><td style="text-align: center;color:#222;"><?php echo L("L_AREA_CZ");?></td></tr>' + res);
...
<body>
  <h1 style="font-size:14px;"><?php echo L('L_MENU_SUPER_change');?></h1>
  ...
  <table class="tab_list" id="tab_show_list" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td style="text-align: center;color:#222;"><?php echo L('L_ALERT_TJ_num');?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_inpressure");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_LINkT");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_LINkS");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_ALERT_TJ_location");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_FMLX");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_PINPAI");?></td>
      <td style="text-align: center;color:#222;"><?php echo L("L_AREA_outtype");?></td>
