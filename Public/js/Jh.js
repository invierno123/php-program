    ...
    return a = {
        init: function (b) {
                ...
                var b =
                    ...
                    c = $("<tr>").append(a._createTd(Jh.Config.tdCls, FQSZ+"\uff1a")).append(b);
                a._ele.mtd = b;
                return c
                ...
                var b = a._createTd(Jh.Config.tdCls2);
                $("<div/>").addClass(Jh.Config.layCls).append(a._createA("1:3")).append(a._createA("3:1")).append(a._createA("1:1:2")).append(a._createA("1:2:1")).append(a._createA("2:1:1")).append("<a href='javascript:void(0);' class='active' rel='1:1:1'>"+MR+"</a>").appendTo(b);
                var c = $("<tr>").append(a._createTd(Jh.Config.tdCls, BJSZ+"\uff1a")).append(b);
                a._ele.layoutTd = b;
                return c
                ...
                var b = $("<a class='button b' href='#' >"+TJFQ+"</a>"),
                    c = $("<a class='button b' href='#' >"+BCPZ+"</a>");
                ...
                b.click(function () {
                    $.fallr("show", {
                            ...
                            button1: {
                                ...
                                onclick: function () {
                                  var b = $(this).children("form"),
                                      e = QU_+":"+b.children("#modulename").val(),
                                  ...
                                  $.get("/home/Systemset/addarea?an="+$("#modulename").val()+"&al="+$("input[name='modulelayout']:checked").val()+"&LMC="+LMC+"&MMC="+MMC+"&RMC="+RMC,function(res_){
                                      if(res_=="0"){
                                        alert(CZSB);
                                      }else{
                                        var ra_value=$("input[name='modulelayout']:checked").val();
                                        if(ra_value=="left"){
                                          LMC++;
                                        }else if(ra_value=="center"){
                                          MMC++;
                                        }else{
                                          RMC++;
                                        }
                        ...
                        content: '<form style="margin-left:20px" ><p>'+FQMC+'\uff1a</p><input type="text" size="15" id="modulename" /><p>'+FQBH+'\uff1a</p><input type="text" size="15" id="modulekey" /><p>'+FQWZ+'\uff1a</p>'+ZB+':<input type="radio" name="modulelayout" checked="checked" value="left"/>&nbsp&nbsp'+ZJ+':<input type="radio" name="modulelayout" value="center"/>&nbsp&nbsp'+YB+':<input type="radio" name="modulelayout" value="right"/><script> $("#modulekey").attr("readonly","readonly");$("#modulekey").val(areaid);</script></form>',
                        icon: "add",
                        position: "center"
                    })
                })
                ...
                a.click(function () {
                    ...
                    "1:1:1" == f && (f = MR);
                    $.fallr("show", {
                        content: "<p>left:[" + a + "]</p><p>center:[" + b + "]</p><p>right[" + d + "]</p><p>"+DQBJ+":" + f + "</p>",
                        position: "center",
                        buttons:{
                          button1: {
                              text: ""+QUEDING,
                              onclick: function () {
                                $.get("/home/Systemset/updatearea?left="+a+"&middle="+b+"&right="+d+"&layout="+f,function(res_){
                                  //alert("操作完成");
                                  $.fallr("hide");
                                });
                              }
...
Jh.Portal = function (a) {
    ...
    return a = {
        init: function (b) {
                ...
                var a = $(i);
                $("<ul style='width:250px;'><li style='cursor:pointer;'><a onclick='show_trapinfo()'>"+JDXX+"</a></li><li style='cursor:pointer;'><a onclick='add_trap()'>"+BJJD+"</a></li></ul>").appendTo(a);
                return a
                ...
                $("." + Jh.Config.close).live("click",
                    function () {
                      if(confirm(QDSC)){
                        var a_this = $(this);
                        $.get("/home/Systemset/delarea?aid="+$(this).parent().parent().parent().attr("id"),function(res_del){
                          a_this.parent().parent().parent().fadeOut("500", function () {
                            var a = a_this,
                                b = a.attr("id"),
